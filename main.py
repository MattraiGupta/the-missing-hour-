Cw='reading';Cv='worried';Cu='focused';C7='idle';C6='Diya';BT='Georgia';BS=float;BR=enumerate;B0='smug';AI=range;A3=.0;k='tired';Z=None;Y=max;S=False;P=True;M='';I=len;H=min;G=int;C9='CASE FILE NO. 17-4';CA='header';Ba='loading';Bb='envelope_wobble';Bc='envelope_fly';Bd='envelope_opening';Be='transition';B1='intro';Bf='divider';CB=Cv;CC='surprised';Bg=BT;B2='letter_reveal';AW='menu';B3='alpha';Cy='side';AX='letter_hold';B4='chapter2_ready';Aa='envelope_idle';Ab='casefile';Ac='label';AJ='spacer';a=Cw;u='gameplay';g='x';b='size';c='y';W='body';O=Z;V='Courier New';R=1.;J='neutral';Q=C6;N=A3;K=S;F=P;import pygame as A,sys,os,random as U,math;A.init();Cz=A.image.load('baricon.png');A.display.set_icon(Cz);B,D=1280,720;Bh=S;AK=A.display.set_mode((B,D),A.RESIZABLE);E=A.Surface((B,D));A.display.set_caption('The Missing Hour');C_=0,0,0;CD=120,120,120;D0=A.font.SysFont(V,28,bold=F);Ad=A.font.SysFont(V,16);D1=A.font.SysFont(V,15);D2=A.font.SysFont(V,16);Bi=A.font.SysFont(Bg,48);D3=A.font.SysFont(V,20);B6=A.font.SysFont(V,16);B7=A.font.SysFont(Bg,26);CE=A.font.SysFont(V,16,bold=F);D4=A.font.SysFont(V,13);CF=A.font.SysFont(V,18);D5=A.font.SysFont(Bg,22);D6=A.font.SysFont(V,20,bold=F);CG=A.font.SysFont(V,19);CH=A.font.SysFont(V,16,bold=F);D7=A.font.SysFont(V,48,bold=F);B8=os.path.dirname(os.path.abspath(__file__))
...
l=v('logo.png',(480,480));CI=v('env.png',(900,563));CJ=v('letter.png',(480,570));CK=v('office.png',(1280,720));B9=v('dialogue_box.png',(1280,200),alpha=F);Bj,BA=900,563;Bk=320
def D9(f):
	try:
...
for(DE,DF)in w.items():
	if not DF:w[DE]=w[J]
BB=K;h=N;BC=0;CN=90;A4=J;Ae=J;CO=[]
